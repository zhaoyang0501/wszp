          ...
          <div class="row" style="margin-bottom: 30px">
           <div class="col-lg-3 col-md-3">
               ...
               <li  ><i class="glyphicon glyphicon-arrow-right"></i> <a href="center">个人信息</a></li>
                  <li class="active"><i class="glyphicon glyphicon-arrow-right"></i> <a href="myresume">我的简历</a></li>
                   <li ><i class="glyphicon glyphicon-arrow-right"></i> <a href="myapply">我的申请记录</a></li>
                   </ul>
              </nav>
            </div>	
            
          	<div class="col-lg-9 col-md-9">
              <h3 style="margin-top: 0px;">我的简历</h3>
              <form class="envor-f1" action="doresume" method="post">
                <input type="hidden" name='id' value="${resume.id }" style="width: 90%"/>
                 <p><label for="drop-name">姓名:</label>${sessionScope.user.name } </p>
                 <p><label for="drop-name">电子邮箱:</label>${sessionScope.user.email} </p>
                    ...
                    <p><label for="drop-name">毕业学校:</label>${sessionScope.user.grade} </p>
                      <p><label for="drop-name">住址:</label>
                      <input type="text" name='addr' value="${resume.addr }" style="width: 90%"/>
                </p>
        
               <p>
               <label for="drop-email">教育经历:</label>
                  <textarea name='edu' rows="5" cols="" style="width: 90%">${resume.edu }</textarea>
               </p>
               
                <p>
               <label for="drop-email">工作经历:</label>
                  <textarea name='work' rows="5" cols="" style="width: 90%">${resume.work }</textarea>
               </p>
               
                  <p>
               <label for="drop-email">项目经历:</label>
                  <textarea name='project' rows="5" cols="" style="width: 90%">${resume.project }</textarea>
               </p>
               
               
                <p>
               <label for="drop-email">自我评价:</label>
                  <textarea name='self' rows="5" cols="" style="width: 90%">${resume.self }</textarea>
               </p>
                <p></label>
                         <button type="submit" class="btn ">更新简历</button>
                </p>
