      ...
      <section class="envor-section envor-home-slider">
        <div id="layerslider" class="envor-layerslider" style="height: 500px;">
          ...
          <div class="ls-layer" style="transition3d: 1,4,5,11; transition2d: 2,8,30;">
            ...
            <img class="ls-bg" src="img/91.gif" alt="layer1-background">
          </div>
          <!--LayerSlider layer-->
          <div class="ls-layer" style="transition3d: 2,3,6,14; transition2d: 4,5,23;">
            <!--LayerSlider background-->
            <img class="ls-bg" src="img/99.gif" alt="layer1-background">
          </div>
          
          <div class="ls-layer" style="transition3d: 3,5,7,15; transition2d: 3,6,26;">
            <!--LayerSlider background-->
            <img class="ls-bg" src="img/93.gif" alt="layer1-background">
          </div>
        </div>
      <!--
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <h2>在线招聘网成立啦！</h2>
              <p>
                 国内集多种媒介资源优势的专业人力资源服务机构，提供包括招聘猎头、培训测评、人事外包和咨询在内的专业人力资源服务；招聘职位覆盖全国104个城市，有效注册用户超过1亿，日招聘职位超过400万。
                 本网站是中国极具有影响的人力资源网站。
              </p>
              <p>
