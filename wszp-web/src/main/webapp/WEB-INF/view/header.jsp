          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <ul class="social-btns">
               <li style=" width: 250px;"><a href="login">企业登录</a></li>
                ...
                <c:if test="${sessionScope.user==null}">
                    <li style=" width: 250px;"><a href="login">会员登录</a></li>
                  </c:if>
              </ul>
            </div>
          </div>
            ...
            <div class="col-lg-12">
              <div class="envor-relative">
                ...
                <div class="envor-logo">
                  ...
                  <p class="logo" style="width: 330px;">在线招聘网站！</p>
                <!--
                ...
                <nav>
                  <ul>
                    ...
                    <li>
                      <a href="${pageContext.request.contextPath}/job">职位检索</a>
                    </li>
                     <li>
                      <a href="${pageContext.request.contextPath}/news">职场资讯</a>
                    </li>
