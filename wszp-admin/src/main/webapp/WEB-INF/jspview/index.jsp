			...
			<div class="sidebar-collapse">
				<ul class="nav" id="side-menu">
					<li class="nav-header">
						...
						<li><a href="#"> <i class="fa fa-calendar-o"></i> <span class="nav-label">后台管理</span> <span class="fa arrow"></span>
						</a>
							<ul class="nav nav-second-level">
							
										<li><a class="J_menuItem" href="job/index">职位管理</a></li>
										<li><a class="J_menuItem" href="apply/index">简历查看</a></li>
										<shiro:hasRole name="admin">
											<li><a class="J_menuItem" href="sys/deptment/index">公司管理</a></li>
											<li><a class="J_menuItem" href="sys/user/index">企业用户管理</a></li>
											<li><a class="J_menuItem" href="frontuser/index">注册用户管理</a></li>	
											<li><a class="J_menuItem" href="news/news/index">职场资讯管理</a></li>
											<li><a class="J_menuItem" href="news/create/index">发职场资讯</a></li>
										</shiro:hasRole>
